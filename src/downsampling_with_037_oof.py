...
train2 = pd.read_csv('input/train_data_candidate_25_2.csv')
print(train2['label'].value_counts())
train3 = pd.read_csv('input/train_data_candidate_25_3.csv')
print(train3['label'].value_counts())
train4 = pd.read_csv('input/train_data_candidate_25_4.csv')
print(train4['label'].value_counts())
train5 = pd.read_csv('input/train_data_candidate_25_5.csv')
...
train.to_csv('input/downsampled_with_oof_037_train_data.csv', index=False)
