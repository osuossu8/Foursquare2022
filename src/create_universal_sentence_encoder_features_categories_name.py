...
for c in ['name', 'categories']:
    ...
    vectors = USEVectorizer().get_vectors(unique_value) 
    print(vectors.shape)

    text_2_text_use_vector = {k:v for k, v in zip(unique_value, vectors)}

    to_pickle(f'features/{c}_2_{c}_use_vector.pkl', text_2_text_use_vector)
