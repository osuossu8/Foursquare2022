...
train['country_code_1'] = get_country_codes(train[['latitude_1', 'longitude_1']])
train['country_code_2'] = get_country_codes(train[['latitude_2', 'longitude_2']])

train['city_rg_1'] = get_cities(train[['latitude_1', 'longitude_1']])
train['city_rg_2'] = get_cities(train[['latitude_2', 'longitude_2']])
...
categorical_cols = ['country_code_1', 'country_code_2', 'city_rg_1', 'city_rg_2']
...
test['country_code_1'] = get_country_codes(test[['latitude_1', 'longitude_1']])
test['country_code_2'] = get_country_codes(test[['latitude_2', 'longitude_2']])

test['city_rg_1'] = get_cities(test[['latitude_1', 'longitude_1']])
test['city_rg_2'] = get_cities(test[['latitude_2', 'longitude_2']])
