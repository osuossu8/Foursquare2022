...
train['same_number'] = int(train['number_1'] == train['number_2'])
...
print(train[['same_number', 'text_sim_mpnet', 'name_longest_substr_ratio', 'address_longest_substr_ratio', 'categories_longest_substr_ratio', 'text_sim_w2v', 'name_sim_use', 'categories_sim_use', 'category_venn']].head())
...
for test_path in tqdm([
    ...
    test['same_number'] = int(test['number_1'] == test['number_2'])
