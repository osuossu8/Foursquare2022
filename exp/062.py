...
for test_path in tqdm([
    'input/train_data_candidate_25_faiss_1.csv',
    'input/train_data_candidate_25_faiss_2.csv',
    'input/train_data_candidate_25_faiss_3.csv',
    'input/train_data_candidate_25_faiss_4.csv',
    'input/train_data_candidate_25_faiss_5.csv'
    ]):
