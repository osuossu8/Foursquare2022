...
print('load data')
train1 = pd.read_csv('input/valid_data1.csv')
print(train1['label'].value_counts())

train2 = pd.read_csv('input/valid_data2.csv')
print(train2['label'].value_counts())

train3 = pd.read_csv('input/valid_data3.csv')
print(train3['label'].value_counts())

train4 = pd.read_csv('input/valid_data4.csv')
print(train4['label'].value_counts())

train5 = pd.read_csv('input/valid_data5.csv')
...
test1 = pd.read_csv('input/train_data1.csv')
test2 = pd.read_csv('input/train_data2.csv')
test3 = pd.read_csv('input/train_data3.csv')
test4 = pd.read_csv('input/train_data4.csv')
test5 = pd.read_csv('input/train_data5.csv')
