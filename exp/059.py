...
print('load data')
train = pd.read_csv('input/train_data_25_faiss_1.csv')
train = reduce_mem_usage(train)
print(train1['label'].value_counts())
train2 = pd.read_csv('input/train_data_25_faiss_2.csv')
train2 = reduce_mem_usage(train2)
print(train2['label'].value_counts())
train3 = pd.read_csv('input/train_data_25_faiss_3.csv')
train3 = reduce_mem_usage(train3)
print(train3['label'].value_counts())
train4 = pd.read_csv('input/train_data_25_faiss_4.csv')
train4 = reduce_mem_usage(train4)
print(train4['label'].value_counts())
train5 = pd.read_csv('input/train_data_25_faiss_5.csv')
...
train.to_csv('input/train_data_25_faiss_all.csv', index=False)
...
for test_path in tqdm([
    'input/valid_data_candidate_25_faiss_1.csv',
    'input/valid_data_candidate_25_faiss_2.csv',
    'input/valid_data_candidate_25_faiss_3.csv',
    'input/valid_data_candidate_25_faiss_4.csv',
    'input/valid_data_candidate_25_faiss_5.csv'
    ]):
