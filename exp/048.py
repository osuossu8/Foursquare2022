...
#id_2_country = {k:v for k, v in zip(data['id'].values, data['country'].fillna('nocountry').values)}
...
id_2_text = unpickle('features/id_2_text.pkl')
id_2_w2v_vec_valid = unpickle(f'features/id_2_w2v_vector_dict_50d_valid_ids.pkl')
