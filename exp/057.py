...
print(train[['text_sim_mpnet', 'name_longest_substr_ratio', 'address_longest_substr_ratio', 'categories_longest_substr_ratio', 'text_sim_w2v', 'name_sim_use', 'categories_sim_use', 'category_venn']].head())
